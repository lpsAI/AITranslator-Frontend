...
const submitForm = (e) =>{
    ...
    if(loginObj.emailId.trim() === "")return setErrorMessage("Email Address is required!")
            ...
            <div className="card mx-auto w-full max-w-5xl  shadow-xl">
                ...
                <div className='py-24 px-10'>
                    ...
                    <form onSubmit={(e) => submitForm(e)}>
                        <div className="mb-4">
                        <InputText type="emailId" defaultValue={loginObj.emailId} updateType="emailId" containerStyle="mt-4" labelTitle="Email Address" updateFormValue={updateFormValue}/>
